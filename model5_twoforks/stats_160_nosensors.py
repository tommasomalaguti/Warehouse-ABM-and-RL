...
# Load your dataset
data = pd.read_csv("/Users/tommasomalaguti/Documents/Python/Tesi/model5_twoforks/simulation_results_nosensors_160_model5_twoforks.csv")
...
time_intervals = range(10, 161, 10)  
