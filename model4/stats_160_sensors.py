...
# Load your dataset
data = pd.read_csv("/Users/tommasomalaguti/Documents/Python/Tesi/model4/simulation_results_sensors_160_model4.csv")
...
summary_data.to_excel("summary_data_160h_sensors.xlsx", index=False, engine='openpyxl')

# Save the summary table to a CSV file
summary_data.to_csv("summary_data_160h_sensors.csv", index=False)
