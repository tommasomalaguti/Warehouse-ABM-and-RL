...
class ForkliftEnv(gym.Env):
    def __init__(self, alpha=2):
        ...
        self.csv_file = open('forklift_training_sim_results_acc.csv', mode='w', newline='')
    ...
    def step(self, action):
        ...
        if self.current_task == 0:  # Loading
            ...
            # Additional penalty if an accident occurs
            if accident_occurred == "Yes":
                reward -= 10  # Apply a penalty of 10 (you can adjust this value)
