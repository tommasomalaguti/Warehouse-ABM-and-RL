...
csv = "/Users/tommasomalaguti/Documents/Python/Tesi/model5_ml/results_data_1/forklift_training_sim_results_1_0_qalpha.csv"
...
plt.title('Cumulative Reward Across Different Runs when α=1')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig('cumulative_reward_across_runs_1q.pdf', dpi=300)
plt.savefig('cumulative_reward_across_runs_1q.png', dpi=600)
plt.close()
...
plt.title('Learning Curve Over 5 Runs when α=1', fontsize=16)  # Increase font size for the title
...
# Save the plot
plt.savefig('mean_reward_trend_with_scaled_std_1q.pdf', dpi=300)
plt.savefig('mean_reward_trend_with_scaled_std_1q.png', dpi=600)
plt.close()
...
plt.title('Reward Distribution Over All Episodes when α=1')
plt.tight_layout()
plt.savefig('reward_distribution_1q.pdf', dpi=300)
plt.savefig('reward_distribution_1q.png', dpi=600)
plt.close()
...
plt.title('Smoothed Mean Energy Consumption Over Time (Averaged Across 5 Runs) when α=1')
plt.legend(fontsize=12)
plt.grid(True)

# Save and show the plot
plt.tight_layout()
plt.savefig('smoothed_mean_energy_consumption_trend_1q.pdf', dpi=300)
plt.savefig('smoothed_mean_energy_consumption_trend_1q.png', dpi=600)
plt.close()
...
plt.title('Smoothed Mean Accident Probability Over Time (Averaged Across 5 Runs) when α=1')
plt.legend(fontsize=12)
plt.grid(True)

# Save and show the plot
plt.tight_layout()
plt.savefig('smoothed_mean_accident_probability_trend_1q.pdf', dpi=300)
plt.savefig('smoothed_mean_accident_probability_trend_1q.png', dpi=600)
plt.close()
...
plt.xlabel('Episode')
plt.ylabel('Value')
plt.title('Comparison of Smoothed Accident Probability and Random Value with Different Window Sizes when α=1')
plt.legend(loc='lower left', fontsize=10)
plt.tight_layout()
plt.savefig('smoothed_comparison_accident_probability_random_value_1q.pdf', dpi=300)
plt.savefig('smoothed_comparison_accident_probability_random_value_1q.png', dpi=600)
plt.close()
...
plt.xlabel('Episode')
plt.ylabel('Value')
plt.title('Comparison of Smoothed Mean Accident Probability and Energy Consumption Over Time when α=1')
plt.legend(fontsize=12)
plt.grid(True)

# Save and show the plot
plt.tight_layout()
plt.savefig('comparison_mean_accident_probability_energy_consumption_1q.pdf', dpi=300)
plt.savefig('comparison_mean_accident_probability_energy_consumption_1q.png', dpi=600)
plt.close()
...
ax.set_title('3D Scatter Plot of Energy Consumption vs. Episode vs. Accident Probability when α=1')
...
# Save the plot
plt.savefig('3d_scatter_plot_1q.pdf', dpi=300)
plt.savefig('3d_scatter_plot_1q.png', dpi=600)
plt.close()