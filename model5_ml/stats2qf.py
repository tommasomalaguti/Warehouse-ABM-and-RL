...
csv = "/Users/tommasomalaguti/Documents/Python/Tesi/model5_ml/forklift_training_sim_results_2_qalpha_maxed.csv"
...
plt.savefig('combined_rewards_mean_trend_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend(loc='upper left')  # Set a specific location for the legend
plt.savefig('episode_rewards_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend(loc='upper left')  # Set a specific location for the legend
plt.savefig('mean_reward_trend_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('max_energy_per_episode_1.5.png')  # Save plot as a file
plt.show()
...
plt.tight_layout()
plt.savefig('energy_vs_accident_probability_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('smoothed_accident_probability_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('smoothed_comparison_accident_probability_random_value_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('comparison_accident_probability_energy_consumption_1.5.png')  # Save plot as a file
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('smoothed_energy_consumption_over_time_1.5.png')  # Save plot as a file
plt.show()
