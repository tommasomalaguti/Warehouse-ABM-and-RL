...
# Load your dataset
data = pd.read_csv("/Users/tommasomalaguti/Documents/Python/Tesi/model1/simulation_results_nosensors_1000_model1.csv")
...
# Apply the conversion and store it as 'Operation Time'
