import argparse
import pandas as pd
from model1_sensors import WarehouseModel
...
def main(total_time_hours=None, max_cycles=None):
    ...
    forklift_data.to_csv("simulation_results_sensors_1000_2_model1.csv")
    ...
    speeds_data.to_csv("speeds_used_sensors_model1.csv", index=False)
