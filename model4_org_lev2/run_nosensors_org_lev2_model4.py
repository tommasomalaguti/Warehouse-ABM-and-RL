import argparse
import pandas as pd
from model4_nosensors_org_lev2 import WarehouseModel2
...
def main(total_time_hours=None, max_cycles=None):
    ...
    forklift_data.to_csv("simulation_results_nosensors_160_model4_org_lev2.csv")
    ...
    speeds_data.to_csv("speeds_used_model4_org_lev2.csv", index=False)
    ...
    searching_speeds_data.to_csv("searching_speeds_used_model4_org_lev2.csv", index=False)
