...
class Forklift2(Agent):
    def __init__(self, unique_id, model, empty_speed, loaded_speed, load_time, unload_time, searching_speed, color, visited_color):
        ...
        self.zone_1_coords = [(x, y) for x in range(0, 30) for y in range(17, 30)]
        ...
        self.waitpoints = self.zone_1_path + self.zone_2_path + self.zone_3_path  # Include all waitpoints
