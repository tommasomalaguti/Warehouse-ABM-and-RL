...
from agent_nosensors_model5 import Forklift2, NormalWall, StorageWall, StorageZone, WaitPoint
import numpy as np
...
class WarehouseModel2(Model):
    ...
    def print_samples(self):
        ...
        plt.tight_layout()
        plt.savefig('monte_carlo_samples.pdf', format='pdf', dpi=300)
        plt.savefig('monte_carlo_samples.png', format='png', dpi=600)
        plt.show()
