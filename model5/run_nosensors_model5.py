import argparse
import pandas as pd
from model5_nosensors import WarehouseModel2
...
def main(total_time_hours=None, max_cycles=None):
    ...
    forklift_data.to_csv("simulation_results_nosensors_1000_2_model5.csv")
    ...
    speeds_data.to_csv("speeds_used_model.csv", index=False)
    ...
    searching_speeds_data.to_csv("searching_speeds_used_model.csv", index=False)
